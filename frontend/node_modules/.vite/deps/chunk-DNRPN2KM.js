...
function moveToTransformationUncached(kpuzzle, move) {
  function getTransformationData(key, multiplyAmount) {
    ...
    const derivedDef = (_a13 = kpuzzle.definition.derivedMoves) == null ? void 0 : _a13[s];
    if (derivedDef) {
...
function isOrbitPatternDataIdentical(orbitDefinition, orbitPatternData1, orbitPatternData2, options = {}) {
  var _a13, _b;
  for (let idx = 0; idx < orbitDefinition.numPieces; idx++) {
    if (!(options == null ? void 0 : options.ignorePieceOrientations) && (orbitPatternData1.orientation[idx] !== orbitPatternData2.orientation[idx] || (((_a13 = orbitPatternData1.orientationMod) == null ? void 0 : _a13[idx]) ?? 0) !== (((_b = orbitPatternData2.orientationMod) == null ? void 0 : _b[idx]) ?? 0))) {
      return false;
    }
...
var KPuzzle = (_a2 = class {
  ...
  toTransformation(source) {
    ...
    } else if ((_a13 = source == null ? void 0 : source.is) == null ? void 0 : _a13.call(source, Alg)) {
      return this.algToTransformation(source);
...
function getFaceletStickeringMask(stickeringMask, orbitName, pieceIdx, faceletIdx, hint) {
  ...
  const faceletStickeringMask = (_a13 = pieceStickeringMask.facelets) == null ? void 0 : _a13[faceletIdx];
...
async function asyncGetPuzzleGeometry(puzzleName) {
  const puzzleGeometry = await import("./puzzle-geometry-SCYXGTEF.js");
...
var _setOrientationModTo1ForPiecesOfOrbits, _cachedPG, _cachedBasePG, _cachedKPuzzle, _cachedSVG, _a3;
var PGPuzzleLoader = (_a3 = class {
  ...
  constructor(info) {
    ...
    __privateAdd(this, _setOrientationModTo1ForPiecesOfOrbits);
    __privateAdd(this, _cachedPG);
    __privateAdd(this, _cachedBasePG);
    ...
    __privateSet(this, _setOrientationModTo1ForPiecesOfOrbits, info.setOrientationModTo1ForPiecesOfOrbits);
  }
  pg() {
    return __privateGet(this, _cachedPG) ?? __privateSet(this, _cachedPG, asyncGetPuzzleGeometry(this.pgId ?? this.id));
  }
  basePG() {
    return __privateGet(this, _cachedBasePG) ?? __privateSet(this, _cachedBasePG, asyncGetBasePuzzleGeometry(
      this.pgId ?? this.id
    ));
  }
  kpuzzle() {
    return __privateGet(this, _cachedKPuzzle) ?? __privateSet(this, _cachedKPuzzle, asyncGetKPuzzle(
      this.pg(),
      this.id,
      __privateGet(this, _setOrientationModTo1ForPiecesOfOrbits)
    ));
  }
  svg() {
    return __privateGet(this, _cachedSVG) ?? __privateSet(this, _cachedSVG, (async () => (await this.pg()).generatesvg())());
  }
}, _setOrientationModTo1ForPiecesOfOrbits = new WeakMap(), _cachedPG = new WeakMap(), _cachedBasePG = new WeakMap(), _cachedKPuzzle = new WeakMap(), _cachedSVG = new WeakMap(), _a3);
var CubePGPuzzleLoader = class extends PGPuzzleLoader {
  constructor() {
    ...
    __publicField(this, "algTransformData", cubeMirrorTransforms);
  }
...
function experimentalIs3x3x3Solved(pattern, options) {
  ...
  return !!((_a13 = pattern.experimentalToTransformation()) == null ? void 0 : _a13.isIdentityTransformation());
}
...
async function descAsyncGetPuzzleGeometry(desc, options) {
  ...
  return puzzleGeometry.getPuzzleGeometryByDesc(desc, {
    allMoves: (options == null ? void 0 : options.allMoves) ?? true,
    orientCenters: (options == null ? void 0 : options.orientCenters) ?? true,
    addRotations: (options == null ? void 0 : options.addRotations) ?? true,
    ...options
  });
}
...
var bigCubePuzzleOrientation = getCached(
  () => import("./big-puzzle-orientation-ZVZQJEF5-JQAVPOCO.js")
);
...
function firstOfType(axis, moveSourceType) {
  var _a13;
  const entry = (_a13 = byAxisThenType[axis][moveSourceType]) == null ? void 0 : _a13[0];
  if (!entry) {
    throw new Error(
...
var cube3x3x3 = {
  ...
  svg: getCached(async () => {
    return (await import("./puzzles-dynamic-3x3x3-FYXD7SIU-ZYGCHHAO.js")).cube3x3x3SVG;
  }),
  llSVG: getCached(async () => {
    return (await import("./puzzles-dynamic-3x3x3-FYXD7SIU-ZYGCHHAO.js")).cube3x3x3LLSVG;
  }),
  llFaceSVG: getCached(async () => {
    return (await import("./puzzles-dynamic-3x3x3-FYXD7SIU-ZYGCHHAO.js")).cube3x3x3LLFaceSVG;
  }),
  pg: getCached(async () => {
...
var cube2x2x2 = {
  ...
  kpuzzle: getCached(async () => {
    const kpuzzle = new KPuzzle(
      (await import("./puzzles-dynamic-side-events-IMYJ533P-JZFA7T4Z.js")).cube2x2x2JSON
    );
    kpuzzle.definition.experimentalIsPatternSolved = experimentalIs2x2x2Solved;
    return kpuzzle;
  }),
  svg: async () => (await import("./puzzles-dynamic-side-events-IMYJ533P-JZFA7T4Z.js")).cube2x2x2SVG,
  llSVG: getCached(
    async () => (await import("./puzzles-dynamic-side-events-IMYJ533P-JZFA7T4Z.js")).cube2x2x2LLSVG
  ),
  pg: getCached(async () => {
...
cube4x4x4.llSVG = getCached(async () => {
  return (await import("./puzzles-dynamic-4x4x4-REUXFQJ4-ZA4CHRWY.js")).cube4x4x4LLSVG;
});
...
var BabyFTOPuzzleLoader = class extends PGPuzzleLoader {
  constructor() {
    ...
    __publicField(this, "svg", getCached(async () => {
      return (await import("./puzzles-dynamic-unofficial-P3TW433I-LQPQOAD4.js")).babyFTOSVG;
    }));
    __publicField(this, "keyMapping", async () => ftoKeyMapping);
  }
  stickeringMask(stickering) {
...
var clock = {
  ...
  kpuzzle: getCached(
    async () => new KPuzzle(
      (await import("./puzzles-dynamic-side-events-IMYJ533P-JZFA7T4Z.js")).clockJSON
    )
  ),
  svg: getCached(async () => {
    return (await import("./puzzles-dynamic-side-events-IMYJ533P-JZFA7T4Z.js")).clockSVG;
  })
};
var FTOPuzzleLoader = class extends PGPuzzleLoader {
  constructor() {
    ...
    __publicField(this, "svg", getCached(async () => {
      return (await import("./puzzles-dynamic-unofficial-P3TW433I-LQPQOAD4.js")).ftoSVG;
    }));
    __publicField(this, "keyMapping", async () => ftoKeyMapping);
    __publicField(this, "algTransformData", {
      "↔ Mirror (x)": {
        replaceMovesByFamily: {
          L: "R",
          R: "L",
...
var kilominx = {
  ...
  svg: getCached(async () => {
    return (await import("./puzzles-dynamic-unofficial-P3TW433I-LQPQOAD4.js")).kilominxSVG;
  })
};
var loopover = {
  id: "loopover",
  ...
  kpuzzle: getCached(
    async () => new KPuzzle(
      (await import("./puzzles-dynamic-unofficial-P3TW433I-LQPQOAD4.js")).loopoverJSON
    )
  ),
  svg: async () => {
    return (await import("./puzzles-dynamic-unofficial-P3TW433I-LQPQOAD4.js")).loopoverSVG;
  }
};
...
var MegaminxPuzzleLoader = class extends PGPuzzleLoader {
  constructor() {
    ...
    __publicField(this, "llSVG", getCached(async () => {
      return (await import("./puzzles-dynamic-megaminx-2LVHIDL4-LSGFK72J.js")).megaminxLLSVG;
    }));
    __publicField(this, "keyMapping", async () => megaminxKeyMapping);
  }
  stickeringMask(stickering) {
...
var melindas2x2x2x2 = {
  ...
  kpuzzle: getCached(
    async () => new KPuzzle(
      (await import("./puzzles-dynamic-side-events-IMYJ533P-JZFA7T4Z.js")).melindas2x2x2x2OrbitJSON
    )
  ),
  svg: getCached(async () => {
    return (await import("./puzzles-dynamic-side-events-IMYJ533P-JZFA7T4Z.js")).melindas2x2x2x2OrbitSVG;
  })
};
var PyraminxPuzzleLoader = class extends PGPuzzleLoader {
  constructor() {
    ...
    __publicField(this, "svg", getCached(async () => {
      return (await import("./puzzles-dynamic-side-events-IMYJ533P-JZFA7T4Z.js")).pyraminxSVG;
    }));
    __publicField(this, "algTransformData", {
      "↔ Mirror (x)": {
        replaceMovesByFamily: {
...
var rediCube = {
  ...
  kpuzzle: getCached(
    async () => new KPuzzle(
      (await import("./puzzles-dynamic-unofficial-P3TW433I-LQPQOAD4.js")).rediCubeJSON
    )
  ),
  svg: async () => {
    return (await import("./puzzles-dynamic-unofficial-P3TW433I-LQPQOAD4.js")).rediCubeSVG;
  }
};
var square1 = {
  id: "square1",
  ...
  kpuzzle: getCached(
    async () => new KPuzzle(
      (await import("./puzzles-dynamic-side-events-IMYJ533P-JZFA7T4Z.js")).sq1HyperOrbitJSON
    )
  ),
  svg: getCached(async () => {
    return (await import("./puzzles-dynamic-side-events-IMYJ533P-JZFA7T4Z.js")).sq1HyperOrbitSVG;
  })
};
var tri_quad = {
  id: "tri_quad",
  ...
  kpuzzle: getCached(
    async () => new KPuzzle(
      (await import("./puzzles-dynamic-side-events-IMYJ533P-JZFA7T4Z.js")).triQuadJSON
    )
  ),
  svg: getCached(async () => {
    return (await import("./puzzles-dynamic-side-events-IMYJ533P-JZFA7T4Z.js")).triQuadSVG;
  })
};
var puzzles = {
...
// node_modules/cubing/dist/lib/cubing/chunks/chunk-DQGYYYHZ.js
...
var _children, _rawListeners, _TwistyPropParent_instances, scheduleRawDispatch_fn, _rawDispatchPending, dispatchRawListeners_fn, _freshListeners, _a6;
...
var _parents, _cachedLastSuccessfulCalculation, _cachedLatestGenerationCalculation, _TwistyPropDerived_instances, getParents_fn, cacheDerive_fn, _a8;
var TwistyPropDerived = (_a8 = class extends TwistyPropParent {
  ...
  async get() {
    ...
    if (((_a13 = __privateGet(this, _cachedLatestGenerationCalculation)) == null ? void 0 : _a13.generation) === generation) {
...
var _a10;
var PR = Math.round(((_a10 = globalThis == null ? void 0 : globalThis.window) == null ? void 0 : _a10.devicePixelRatio) ?? 1);
var WIDTH = 80 * PR;
var HEIGHT = 48 * PR;
var TEXT_X = 3 * PR;
var TEXT_Y = 2 * PR;
...
async function bulk3DCode() {
  return cachedConstructorProxy ?? (cachedConstructorProxy = import("./twisty-dynamic-3d-VGZIQ64W-6BFPTDXD.js"));
}
...
var _dragInfoMap, _targetListeners, _lazyListenersRegistered, _DragTracker_instances, registerLazyListeners_fn, clear_fn, trackDrag_fn, _a11;
...
var _Twisty3DVantage_instances, setupBasicPresses_fn, _onResizeStaleDropper, _width, _height, onResize_fn, _cachedRenderer, _cachedCanvas, _cachedDragTracker, dragTracker_fn, _cachedCamera, _cachedOrbitControls, _disconnectionFunctions2, _experimentalNextRenderFinishedCallback, _scheduler, _a12;
var Twisty3DVantage = (_a12 = class extends ManagedCustomElement {
  ...
  async connectedCallback() {
    ...
    void __privateMethod(this, _Twisty3DVantage_instances, onResize_fn).call(this);
    ...
    void __privateMethod(this, _Twisty3DVantage_instances, setupBasicPresses_fn).call(this);
    this.scheduleRender();
  }
  async clearCanvas() {
  ...
  async canvasInfo() {
    return __privateGet(this, _cachedCanvas) ?? __privateSet(this, _cachedCanvas, (async () => {
      ...
      (_a13 = this.loadingElement) == null ? void 0 : _a13.remove();
      const context = canvas.getContext("2d");
    ...
    return __privateGet(this, _cachedCamera) ?? __privateSet(this, _cachedCamera, (async () => {
      ...
      camera.position.copy(
        new (await bulk3DCode()).ThreeVector3(2, 4, 4).multiplyScalar(
          ((_a13 = this.options) == null ? void 0 : _a13.backView) ? -1 : 1
        )
      );
      camera.lookAt(0, 0, 0);
      return camera;
  ...
  async orbitControls() {
    return __privateGet(this, _cachedOrbitControls) ?? __privateSet(this, _cachedOrbitControls, (async () => {
      ...
      const orbitControls = new TwistyOrbitControls(
        this.model,
        !!((_a13 = this.options) == null ? void 0 : _a13.backView),
        ...
        this.addListener(
          ...
          async (orbitCoordinates) => {
            ...
            void setCameraFromOrbitCoordinates(
              camera,
              orbitCoordinates,
              (_a14 = this.options) == null ? void 0 : _a14.backView
            );
            this.scheduleRender();
          }
        );
  ...
  async render() {
    ...
    (_a13 = this.stats) == null ? void 0 : _a13.begin();
  ...
  return __privateGet(this, _cachedDragTracker) ?? __privateSet(this, _cachedDragTracker, (async () => {
    ...
    (_a13 = this.model) == null ? void 0 : _a13.twistySceneModel.dragInput.addFreshListener(
      (dragInputMode) => {
...
//# sourceMappingURL=chunk-DNRPN2KM.js.map
