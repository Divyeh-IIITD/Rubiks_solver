...
var AlgWalker = class extends TraversalDownUp {
  constructor(kpuzzle, algOrAlgNode, apd) {
    ...
    __publicField(this, "goalIndex");
    __publicField(this, "goalDuration");
    this.kpuzzle = kpuzzle;
...
var Twisty2DPuzzle = (_a3 = class extends ManagedCustomElement {
  ...
  constructor(model, kpuzzle, svgSource, options, puzzleLoader) {
    ...
    __publicField(this, "hintFaceletsClassListManager", new ClassListManager(
      this,
      "hint-facelets-",
...
var TwistyButtons = (_a9 = class extends ManagedCustomElement {
  ...
  switch (command) {
    ...
    case "twizzle-link": {
      void ((_f = this.controller) == null ? void 0 : _f.visitTwizzleLink());
      break;
    }
    default:
...
var TwistySceneModel = class {
  constructor(twistyPlayerModel) {
    ...
    __publicField(this, "hintFaceletsElevation", new HintFaceletsElevationProp());
...
var TwistyAlgViewer = (_a15 = class extends HTMLElementShim {
  ...
  set twistyPlayer(twistyPlayer) {
    void __privateMethod(this, _TwistyAlgViewer_instances, setTwistyPlayer_fn).call(this, twistyPlayer);
  }
  ...
  async connectedCallback() {
    ...
    if (["/edit/", "/explore/"].includes(pathname)) {
      ...
      if (config.puzzle && !(config.puzzle in puzzles)) {
        const puzzleDescription = (await import("./puzzle-geometry-SCYXGTEF.js")).getPuzzleDescriptionString(config.puzzle);
